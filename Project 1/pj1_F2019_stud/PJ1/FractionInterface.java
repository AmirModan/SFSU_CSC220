...
public interface FractionInterface 
{
	 ...
	 *        Do not reduce and moveMinusSign the fraction object.
	  ...
	  * @return this fraction object */
        ...
        /** Task: change the fraction so that the minus sign is indicated by numerator.
	  *       exmaple: -3/-10 --> 3/10  3/-10 --> -3/10
	  * @return this fraction object */
        public FractionInterface moveMinusSign();

	/** Task: Converts this fraction to double value
	 ...
	 *  Note: do not Invoke reduce() and moveMinusSign() in the result fraction.*/
