...
class PJ1_Test
{
	...
	System.out.println("  6) equals \t7) moveMinusSign 8) reduce \t9) toDouble \t10) setFraction ");  
	      ...
	      switch (op) {
			...
			System.out.println("\t" + n1 + " eq "+ n1 + " = " + n1.equals(n1));
		        ...
		        break;
             	...
             	case 7:  
			System.out.println("\t" + n1 + " moveMinusSign= " + n1.moveMinusSign());
		        break;
             	case 8:  
			System.out.println("\t" + n1 + " reduce= " + n1.reduce());
		        break;
            	case 9: 
